...
public class OrdinaryPreferencesActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		okButton.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				savePreferences();
				OrdinaryPreferencesActivity.this.setResult(RESULT_OK);
				finish();
			}
		});
		...
		cancelButton.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				OrdinaryPreferencesActivity.this.setResult(RESULT_CANCELED);
				finish();
			}
		});
	}
	...
	private void updateUIFromPreferences() {
		...
		autoUpdateCheckBox.setChecked(autoUpChecked);
	}
